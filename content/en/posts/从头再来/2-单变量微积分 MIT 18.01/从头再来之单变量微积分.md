...
$$ \begin{aligned} 
&f^{\prime}(x)>0 \Rightarrow f(x) \text{递增}\\\\\\\\ 
&f^{\prime}(x)<0 \Rightarrow f(x) \text{递减}\\\\\\\\ 
&f^{\prime\prime}(x)>0 \Rightarrow f^{\prime}(x) \text{递增} \Rightarrow f(x) \text{为凸函数}\\\\\\\\ 
&f^{\prime\prime}(x)<0 \Rightarrow f^{\prime}(x) \text{递减} \Rightarrow f(x) \text{为凹函数}\\\\\\\\     
\end{aligned} $$
