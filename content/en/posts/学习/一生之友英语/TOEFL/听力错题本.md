...
1. 主旨题
    ...
    C. Difference，出现了比较的含义，托福很爱在**选项中**给出对比的含义，但是**文章中**并没有对比
...
|words|explanation|audio|remark|
|:--:|:--:|:--:|:--:|
|parchment|n. 羊皮纸|{{< words src="parchment">}}|The parchment is animal skin that's stretched and dried under tension so it become really flat and can be written on. <br> 羊皮纸是一种经动物的皮被拉伸并在压力下使之干燥，所以他就变得非常平坦并且能在上面写字 <br>{{< words src="The parchment is animal skin that's stretched and dried under tension so it become really flat and can be written on.">}} |
|come in handy|非常有用；派上用场的|{{< words src="come in handy">}}|Parchment is durable, much more so than paper, and it could be reused which came in handy since it was costly material and in short supply. <br> 羊皮纸很耐用，比纸张耐用的多，而且可以重复使用，这就变得很便利，因为羊皮纸是很贵的材料并且供应短缺。<br> {{< words src="Parchment is durable, much more so than paper, and it could be reused which came in handy since it was costly material and in short supply.">}}|
|monk|n. 和尚|{{< words src="monk">}}||
|scribe|n. 手抄员|{{< words src="scribe">}}|So parchment wasn't uncommon for the scribes or monks who produced the manuscripts. <br> 因此对于那些手抄员和和尚来说，羊皮纸的使用并不少见 <br> 这里有两层否定，而且读的很快很难理解意思，wasn't uncommon， 因为前面说的是羊皮纸的优点 (expensive & short in supply 是客观陈述) <br>{{< words src="So parchment wasn't uncommon for the scribes or monks who produced the manuscripts.">}}|
|abrasive|adj. 粗糙的；有研磨效果的 n. 研磨料|{{< words src="abrasive">}}|In the last Middle Ages, it was customary to scrape away the surface of the parchment with an abrasive, wihch completely wiped out any writing that was there. <br> 在中世纪晚期，人们习惯用一种研磨料对羊皮纸表面进行擦拭，这种方式能完全擦掉上面的墨迹 <br> {{< words src="In the last Middle Ages, it was customary to scrape away the surface of the parchment with an abrasive, wihch completely wiped out any writing that was there.">}}|
|||{{< words src="">}}||
...
2. 多选题
    ...
    {{< words src="Stained glass, of course, is simply glass that has been colored and, uh, cut into pieces and reassembled to form a picture or decorative design.">}}
...
|words|explanation|audio|remark|
|:--:|:--:|:--:|:--:|
|stained|adj. 着色的；玷污的|{{< words src="stained">}}|stained glass 花窗玻璃|
|paradigmatic|adj. 典型的；典范的|{{< words src="paradigmatic">}}||
...
2. B. Her role in professional art organization这个是在后面和男生对话中才体现出来的，其中organization替换了institution

3. 如何体现尊敬？ Beaux had high regard for Sargent's work. {{< words src="Beaux had high regard for Sargent's work">}} 博斯对萨金特的作品评价非常的高
...
1. 主旨，这个没啥问题，一开始就点明想聊的是Neel的Style

2. 细节，这个也没啥大问题，文章中提到hard time是因为photography的出现代替了potrait
...
|words|explanation|audio|remark|
|:--:|:--:|:--:|:--:|
|depiction|n. 描绘；描述|{{< words src="depiction">}}||
|elongate|v. 拉伸；延长 adj. 拉伸的|{{< words src="elongate">}}||
|stretchy|adj. 弹性的；伸展的|{{< words src="stretchy">}}||
|||{{< words src="">}}||
|||{{< words src="">}}||
...
|words|explanation|audio|remark|
|:--:|:--:|:--:|:--:|
|erect|v. 建立；竖起|{{< words src="erect">}}|It was about five thousand years ago, even before the first Egyptian pyraimd; that's some Neolithic monuments, tombs were erected at various sites around Ireland, Great Britain and coastal island nearby. <br> 那是大约五千年前，甚至在第一座埃及金字塔之前。 那是一些新石器时代的纪念碑，在爱尔兰，英国和附近的沿海岛屿周围的各个地方都竖立了坟墓。<br> {{< words src="It was about five thousand years ago, even before the first Egyptian pyraimd; that's some Neolithic monuments, tombs were erected at various sites around Ireland, Great Britain and coastal island nearby.">}}|
|monument|n. 纪念碑 v. 为...树碑|{{< words src="monument">}}|Passage graves were just monuments to honor the dead buried there. <br>|
|tomb|n. 坟墓|{{< words src="tomb">}}||
|passage|n. (书、演讲、乐曲的)段落；阶段；过道；通道；过渡；迁徙|{{< words src="passage">}}|These structure are called Passage Graves, because the inner chamber, sometimes several chambers in fact, could only through a narrow passage way. <br> 这些建筑被称为通道式坟墓，因为在这些房间里面，事实上几个房间，只能通过一个狭窄的通道 <br> {{< words src="These structure are called Passage Graves, because the inner chamber, sometimes several chambers in fact, could only through a narrow passage way.">}}|
|alternate|v. 交替；轮流|{{< words src="alternate">}}|The volume seems to alternate between very load and very soft. <br> 音量似乎会在大声和柔声之间轮流转变|
|alternative|adj. 可替代的|{{< words src="alternative">}}||
|||{{< words src="">}}||
|||{{< words src="">}}||
...
|words|explanation|audio|remark|
|:--:|:--:|:--:|:--:|
|crane|n. 吊车，起重机|{{< words src="crane">}}||
|lift|v. 抬起；举起；吊起|{{< words src="lift">}}|Wooden cranes would have been too weak to lift the blocks. <br> 木质起重机太脆弱不能抬起石块 <br> {{< words src="Wooden cranes would have been too weak to lift the blocks.">}} <br> The problem that has puzzled scholars for centuries is how were these blocks lifted up the height of this massive structure and then fit into place and without the benefit of modern technology. <br> 困扰了学者们几个世纪的问题就是，在没有现代科技的帮助下，这些石块是怎么被搬起来，并且放到合适位置上的 <br> {{< words src=" The problem that has puzzled scholars for centuries is how were these blocks lifted up the height of this massive structure and then fit into place and without the benefit of modern technology. ">}}|
|ramp|n. 斜坡|{{< words src="ramp">}}|The next one has to do with the use of a ramp that would allow workers to drag a stone block up the side of the structure. <br> 下一个理论是说使用斜坡使得工人们可以把石块拖拽到建筑的上边 <br> {{< words src="The next one has to do with the use of a ramp that would allow workers to drag a stone block up the side of the structure. ">}}|
|plateau|n. 高原|{{< words src="plateau">}}|The plateau is simply not big enough to accommodate a two-kilometer-long ramp. <br> 高原地带不足以容纳一个2km场的坡道  <br> {{< words src="The plateau is simply not big enough to accommodate a two-kilometer-long ramp.">}}|
|||{{< words src="">}}||
|||{{< words src="">}}||
...
|words|explanation|audio|remark|
|:--:|:--:|:--:|:--:|
|sedentary|adj. 定居的|{{< words src="sedentary">}}|Sedentary lifestyle means that they stoppedbeing nomadic, taht they began staying in one area year around instead of moving around all the time. <br> 定居的生活方式意味着他们停止了游牧的生活，开始常年待在一个地方而不是东奔西跑 <br> {{< words src="Sedentary lifestyle means that they stoppedbeing nomadic, taht they began staying in one area year around instead of moving around all the time.">}}|
|nomadic|adj. 游牧的|{{< words src="nomadic">}}||
|grain|n. 谷物|{{< words src="grain">}}|Archaeologists have uncovered numerous circular structure dating from that period that appear to have been used to store grain. <br> 考古学家发现了那个年代建了很多圆形建筑来储存食物 <br> {{< words src="Archaeologists have uncovered numerous circular structure dating from that period that appear to have been used to store grain.">}}|
|barley|n. 大麦|{{< words src="barley">}}|First, the remains of barley houses have been found inside them. Barley was the main type of grain that grew in this area. <br> 首先，在这些建筑里面发现了储存大麦的遗迹，大麦是这里主要的谷物。<br> {{< words src="First, the remains of barley houses have been found inside them. Barley was the main type of grain that grew in this area. ">}}|
|surplus|n. 剩余；过剩|{{< words src="surplus">}}|But do you think one structure would be enough to hold the surplus for an entire settlement? <br> 但是你们觉得，一个粮仓足够储存整个居住地的余粮吗？ <br> {{< words src="But do you think one structure would be enough to hold the surplus for an entire settlement?">}}|
|||{{< words src="">}}||
|||{{< words src="">}}||
|||{{< words src="">}}||
|||{{< words src="">}}||
...
|caterpillar|n. 毛毛虫 (蝴蝶的幼崽)|{{< words src="caterpillar">}}||
|escort|n./v. 护送；护卫；押送|{{< words src="escort">}}|Caterpillar's always attended or escorted by ants. And it always makes its way back to the host plant to feed, guided by the ant, the ant escort service, so to speak. <br> 毛毛虫总是有蚂蚁陪伴或护送。在蚂蚁的引导下，它总是回到寄主植物觅食，可以说是蚂蚁护送服务。<br> {{< words src="Caterpillar's always attended or escorted by ants. And it always makes its way back to the host plant to feed, guided by the ant, the ant escort service, so to speak.">}}|
|||{{< words src="">}}||
|||{{< words src="">}}||
|||{{< words src="">}}||
|||{{< words src="">}}||
