...
|abut|v. 邻接；毗邻|{{< words src="">}}|abut against 紧邻 <br> abut on 接连；邻接|
...
|gross|vt. 总收入 adj. 总的；毛的；粗糙的 n. 毛收入|{{< words src="gross">}}||
...
|agreeable|adj. 使人愉快的|{{< words src="agreeable">}}||
...
|anchor|v. 抛锚；固定；扎根；主持|{{< words src="anchor">}}|Her novels are anchored in everyday experience.|
...
|attempt|n./vi. 尝试；努力|{{< words src="attempt">}}||
